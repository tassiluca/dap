...
import it.unibo.dap.api.NativeProductApi.NativeInterface
...
/** Bindings from / to Scala Native <==> Product API types.
  ...
  */
object NativeProductApi extends JVMNativeAPI:

  override val interface: NativeInterface.type = NativeInterface

  object NativeInterface extends JVMNativeInterface with NativeADTs:
